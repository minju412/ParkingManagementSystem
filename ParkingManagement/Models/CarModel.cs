...
{
    public class CarModel : VehiclesModel
    {
        ...
        // 사용자용 (주차장 이용 중인 차)
        //public override List<CarModel> GetList(string search) // public static
        //{
        ...
        //// 관리자용 (주차장 이용 끝난 차)
        //public override List<CarModel> GetTotalList(string search)
        //{
        ...
        public override int CalcFee(string carnum)
        {
            ...
            model = model.Get(carnum) as CarModel;
            //var model = CarModel.Get(carnum);
